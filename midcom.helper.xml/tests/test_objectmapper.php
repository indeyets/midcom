...
class midcom_helper_xml_objectmapper_test extends UnitTestCase
{
    ...
    var $testdata_1 = "<topic>
                            ...
                            <id>4</id>
                            <name>__Midgard CMS Welcome AIS topic</name>
                            <extra />
                            <score>0</score>
                            <description />
                            <code />
    ...
    function test_objectmapper_object2data()
    {
        ...
        $this->assertTrue(array_key_exists($class, $_MIDGARD['schema']['types']), "The array should have the objectclass as it's first key: $class");
