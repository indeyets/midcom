...
-Copy xd_receiver.html to a folder (/facebook-javascript) that visible to outside (ex: /static/js/). Enables async. communication with facebook server on clientside.
