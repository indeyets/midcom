...
<?
  ...
  } elseif (method_exists($GLOBALS["midcom"],"print_jscripts")) {
     $_MIDCOM->print_jscripts();
  }
?>
<!--[if IE]>
  <style type="text/css">
...
<? }  
 // TODO: change these so the fitt with the css and thus make for better degrading in ie/mac
 /*
...
<body <?php if (method_exists($GLOBALS["midcom"],"print_jsonload")) {
 $GLOBALS["midcom"]->print_jsonload(); 
}
?>   >
