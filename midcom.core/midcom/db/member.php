...
/** @ignore */
require(MIDCOM_ROOT . '/midcom/baseclasses/database/member.php');

/**
 * MidCOM Legacy Database Abstraction Layer
 *
 * This class encaspulates a classic MidgardMember with its original features.
 *
...
class midcom_db_member extends midcom_baseclasses_database_member
{
     ...
     */
    function midcom_db_member($id = null)
    {
        parent::midcom_baseclasses_database_member($id);
    }
