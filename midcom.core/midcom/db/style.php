...
/** @ignore */
require(MIDCOM_ROOT . '/midcom/baseclasses/database/style.php');

/**
 * MidCOM Legacy Database Abstraction Layer
 *
 * This class encaspulates a classic MidgardStyle with its original features.
 *
...
class midcom_db_style extends midcom_baseclasses_database_style
{
     ...
     */
    function midcom_db_style($id = null)
    {
        parent::midcom_baseclasses_database_style($id);
    }
