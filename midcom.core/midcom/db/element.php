...
/** @ignore */
require(MIDCOM_ROOT . '/midcom/baseclasses/database/element.php');

/**
 * MidCOM Legacy Database Abstraction Layer
 *
 * This class encaspulates a classic MidgardElement with its original features.
 *
...
class midcom_db_element extends midcom_baseclasses_database_element
{
     ...
     */
    function midcom_db_element($id = null)
    {
        parent::midcom_baseclasses_database_element($id);
    }
