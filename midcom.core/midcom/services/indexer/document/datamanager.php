 ...
 * @version $Id:datamanager.php 3765 2006-07-31 08:51:39 +0000 (Mon, 31 Jul 2006) tarjei $
 ...
 *   the key 'index_merge_with_content' in the field to true or false respecitvly.
...
class midcom_services_indexer_document_datamanager extends midcom_services_indexer_document_midcom
{
    ...
    function midcom_services_indexer_document_datamanager(&$datamanager)
    {
        ...
        $this->_schema = $schemadb[$this->_datamanager->get_layout_name()];
    ...
    function _process_datamanager()
    {
        ...
        debug_add('Processing datamanager schema ' . $this->_datamanager->get_layout_name());
