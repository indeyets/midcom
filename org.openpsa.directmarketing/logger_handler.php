 ...
 * @version $Id: logger_handler.php,v 1.3 2006/03/30 14:48:20 rambo Exp $
 * @copyright Nemein Oy http://www.nemein.com/
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License
 */
 
/**
 * org.openpsa.directmarketing logger handler and viewer class.
 */
class org_openpsa_directmarketing_logger_handler
{
    var $_datamanagers;
    var $_request_data;
    var $_view = 'default'; 
    ...
    function org_openpsa_directmarketing_logger_handler(&$datamanagers, &$request_data, &$config)
    {
