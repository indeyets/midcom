...
<div class="main">
    <form method="post" name="midcom_helper_datamanager__form" action="&(_MIDGARD["uri"]);" class="datamanager">
        <fieldset class="area">
            <legend><?php echo sprintf($view_data['l10n']->get("edit user account: %s %s"), $view_data['person']->firstname, $view_data['person']->lastname); ?></legend>
            <label for="org_openpsa_contacts_person_account_username">
                ...
                <input type="text" name="org_openpsa_contacts_person_account_username" id="org_openpsa_contacts_person_account_username" class="shorttext" value="<?php echo $view_data['person']->username; ?>" />
            </label>
            ...
            <label for="org_openpsa_contacts_person_account_newpassword2">
                <span class="field_text"><?php echo $view_data['l10n']->get("password repeat"); ?></span>
