...
{
    $j('#midcom_admin_user_batch_process tbody tr').find('td:first').addClass('first');
    $j('#midcom_admin_user_batch_process tbody tr').find('td:last').addClass('last');
    
    $j("#midcom_admin_user_batch_process tbody input[@type='checkbox']").each(function(i)
    {
