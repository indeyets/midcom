...
/**
 * Quickpoll admin page handler
 *
 * @package net.nemein.quickpoll
 */

class net_nemein_quickpoll_handler_admin extends midcom_baseclasses_components_handler
{
    /**
    ...
    function _handler_delete($handler_id, $args, &$data)
    {
        ...
        if (array_key_exists('net_nemein_quickpoll_deleteok', $_REQUEST))
        {
            // Deletion confirmed.
