...
/**
 * Quickpoll create page handler
 *
 * @package net.nemein.quickpoll
 */

class net_nemein_quickpoll_handler_create extends midcom_baseclasses_components_handler
{
    /**
     ...
     */
    function net_nemein_quickpoll_handler_create()
    {
