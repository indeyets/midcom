...
<ul>
    <li>
        ...
        $report_params  = '?org_openpsa_reports_query_data[start][timestamp]=' . $this_month->getTimestamp(); 
        $report_params .= '&org_openpsa_reports_query_data[end][timestamp]=' . $next_month->getTimestamp();
    ...
    <li>
        <?php
        // Invoiceable hours in last month
        $report_params  = '?org_openpsa_reports_query_data[start][timestamp]=' . $prev_month->getTimestamp(); 
        $report_params .= '&org_openpsa_reports_query_data[end][timestamp]=' . $this_month->getTimestamp();
        $report_params .= '&org_openpsa_reports_query_data[style]=builtin:basic';
        $report_params .= '&org_openpsa_reports_query_data[invoiceable_filter]=1';
        $report_params .= '&org_openpsa_reports_query_data[mimetype]=text/html';
        $report_params .= '&org_openpsa_reports_query_data[resource]=all';
