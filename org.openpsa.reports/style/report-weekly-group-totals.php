...
?>
                    <tr class="item">
                        <td><?php echo $view_data['l10n']->get('invoiceable hours'); ?></td>
                        ...
                        <td><?php
                                ...
                                && count($weekly_data_group['invoiceable_total_by_customer']) > 0)
                            {
                                ...
                                */
                                ...
                                {
                                    echo ', ' . $view_data['l10n']->get('no customer') . ' ' . sprintf('%01.2f', $weekly_data_group['invoiceable_total'] - $groups_total);
                                }
                                echo ')';
                            }
                            else
                    ...
                    <tr class="item">
                        <td><?php echo $view_data['l10n']->get('uninvoiceable hours'); ?></td>
                        <?php
                        $extra_classes = false;
                        ...
                        <td><?php
                                ...
                                && count($weekly_data_group['uninvoiceable_total_by_customer']) > 0)
                            {
                                ...
                                */
                                ...
                                {
                                    echo ', ' . $view_data['l10n']->get('no customer') . ' ' . sprintf('%01.2f', $weekly_data_group['uninvoiceable_total'] - $groups_total);
                                }
                                echo ')';
                            }
                            else
                    ...
                    <tr class="totals">
                        <td><?php echo $view_data['l10n']->get('total'); ?></td>
                        ...
                        <td class="numeric"><?php
                            ...
                            {
                                echo sprintf($view_data['l10n']->get('of %01.2f'), $weekly_data_group['person_workhours']);
                            }
                            else
                            {
                                echo '&nbsp;';
