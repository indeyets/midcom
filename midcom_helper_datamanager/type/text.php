 ...
 * @package midcom_helper_datamanager
 */
class midcom_helper_datamanager_type_text extends midcom_helper_datamanager_type_baseclass
{
    /**
    ...
    protected function on_validate()
    {
        ...
        {
            $this->validation_error = 'type text: value may not be array or object';
            return false;
        }
        ...
        {
            $this->validation_error = sprintf(
                'type text: value is longer then %d characters',
                $this->maxlength
            );
            return false;
        }
