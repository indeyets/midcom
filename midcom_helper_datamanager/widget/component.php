 ...
 * @package midcom_helper_datamanager
 */
class midcom_helper_datamanager_widget_component extends midcom_helper_datamanager_widget
{
    /**
    ...
    public function render_html()
    {
        ...
        {
            $selected = '';
            if( $this->type->selection[0] == $value)
            {
                $selected = 'selected="selected"';
            }
            $output .= "        <option $selected value=" . midcom_helper_xsspreventer_helper::escape_attribute($value) . '>' . midcom_helper_xsspreventer_helper::escape_element('option', $label) . "</option>\n"; 
        }
