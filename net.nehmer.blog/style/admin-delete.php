...
<form action="" method="post">
  <input type="submit" name="net_nehmer_blog_deleteok" value="<?php echo $view['l10n_midcom']->get('delete'); ?> " />
  <input type="submit" name="net_nehmer_blog_deletecancel" value="<?php echo $view['l10n_midcom']->get('cancel'); ?>" />
</form>
