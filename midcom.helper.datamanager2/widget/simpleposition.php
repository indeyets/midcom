 ...
 * @version $Id: password.php 10966 2007-06-15 07:00:37Z adrenalin $
...
class midcom_helper_datamanager2_widget_simpleposition extends midcom_helper_datamanager2_widget
{
    ...
    function add_elements_to_form()
    {
        ...
        $this->_form->addElement('text', "{$this->name}_latitude", $this->_translate('latitude'), Array('class' => 'shorttext'));
        $this->_form->addElement('text', "{$this->name}_longitude", $this->_translate('longitude'), Array('class' => 'shorttext'));
