...
jQuery.fn.create_sortable = function(options)
{
    ...
    jQuery(this).create_sortable_rows(options);
    jQuery(this).create_sortable_columns(options);
...
jQuery.fn.create_sortable_rows = function(options)
{
    jQuery(this).find('tfoot td.new_row')
        ...
        .click(function()
        {
            ...
            jQuery(this).parents('table.jquery-enabled').create_sortable(options);
            jQuery(this).rearrange_scores();
...
jQuery.fn.rearrange_scores = function()
{
    ...
    jQuery(this).find('tbody td.midcom_helper_datamanager2_helper_sortable').each(function(i)
    {
        ...
        jQuery(this).find('input.image_sortable').attr('value', i + 1);
    });
...
jQuery.fn.create_sortable_columns = function(options)
{
...
jQuery.fn.move_column = function(direction, options)
{
    ...
    jQuery(options.table_id).create_sortable_columns(options);
}
