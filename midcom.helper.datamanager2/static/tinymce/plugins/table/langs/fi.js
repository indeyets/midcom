...
cols : 'Saraketta',
rows : 'Rivi&auml;',
cellspacing : 'Soluv&auml;litys',
cellpadding : 'Solut&auml;yte',
border : 'Reuna',
align : 'Asettelu',
...
col_limit : 'Olet ylitt&auml;nyt sallitun m&auml;&auml;r&auml;n sarakkeita ({$cols}).',
row_limit : 'Olet ylitt&auml;nyt sallitun m&auml;&auml;r&auml;n rivej&auml; ({$rows}).',
cell_limit : 'Olet ylitt&auml;nyt sallitun m&auml;&auml;r&auml;n soluja ({$cells}).',
missing_scope: 'Oletko varma että haluat jatkaa ilman että olet määrittänyt skaalaa tälle taulukon otsikolle? Skaala (Scope) auttaa ihmisiä joilla on terveydellisiä rajoitteita.',
caption : 'Taulukon selite'
});
