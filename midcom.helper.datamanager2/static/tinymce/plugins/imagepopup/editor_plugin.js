...
tinyMCE.importPluginLanguagePack('imagepopup', 'en');
/****
...
//		alert("Initialization parameter:" + tinyMCE.getParam("template_someparam", false));
		...
		inst.addShortcut('ctrl', 'i', 'land_imagepopup_desc', 'mceImagepopup');
	},
	...
	getControlHTML : function(cn) {
		switch (cn) {
             case "imagepopup":
                return tinyMCE.getButtonHTML(cn, 'lang_imagepopup_desc', '{$themeurl}/images/image.gif', 'mceImagepopup');
		}
...
tinyMCE.addPlugin("imagepopup", TinyMCE_imagepopupPlugin);
