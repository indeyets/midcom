...
/**
 * Basic handler class
 * @package aegir.admin.acls
 */

class midcom_admin_acls_edit extends midcom_baseclasses_components_handler {
    ...
    function midcom_admin_acls_edit() 
    {
    ...
    function _on_initialize() 
    {
        ...
        if (array_key_exists('aegir_interface',$this->_request_data)) {
           $this->_config = &$this->_request_data['aegir_interface']->get_handler_config('midcom.admin.acls');
        }
        // doing this here as this component most probably will not be called by itself.
        $_MIDCOM->style->prepend_component_styledir('midcom.admin.acls');
    ...
    function _handler_edit ($handler_id, $args, &$data)
    {
        ...
        $defaults = array();
        $this->_schema = midcom_helper_datamanager2_schema::load_database($this->_config->get('schemadb_acls'));
        ...
        $this->_request_data['div'] = $this->_object->get_privileges();
        $this->_request_data['schema'] = $this->_schema;
        $this->_request_data['object'] = $this->_object->name;
