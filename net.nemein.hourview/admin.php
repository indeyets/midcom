...
/**
 * Net.nemein.hourview component AIS Class
 * 
 ...
 * @package net.nemein.hourview
 */
class net_nemein_hourview_admin extends midcom_baseclasses_components_request_admin
{
    /**
     * Constructor.
     * 
     ...
     */
    function net_nemein_hourview_admin($topic, $config)
    {
        ...
        ( 
            ...
            'handler' => 'config_dm',
            'schemadb' => 'file:/net/nemein/hourview/config/schemadb_config.inc',
