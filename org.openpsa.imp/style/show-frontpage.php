...
<div class="main">
    <div class="area">
        <h2><?php echo $view_data['l10n']->get('org.openpsa.imp'); ?></h2>
        <!-- Done without JS toolbar etc hiding since in some case IE simply refuses to allow scrollbars in such windows -->
        <p><a href="<?php echo $node[MIDCOM_NAV_FULLURL]; ?>redirect.html" target="_BLANK"><?php echo $view_data['l10n']->get('open horde/imp'); ?></a>
    </div>
</div>
<div class="sidebar">
    <div class="area">
