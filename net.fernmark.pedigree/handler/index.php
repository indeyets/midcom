...
/**
 * This is an URL handler class for net.fernmark.pedigree
 *
 ...
 * @package net.fernmark.pedigree
 */
class net_fernmark_pedigree_handler_index  extends midcom_baseclasses_components_handler 
{
    ...
    {
        $this->_request_data['name']  = "net.fernmark.pedigree";
