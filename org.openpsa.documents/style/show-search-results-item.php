...
?>
<dt style="clear: left;"><a href="&(node[MIDCOM_NAV_FULLURL]);document/<?php echo $data['document']->guid; ?>/"><?php echo $view['title']; ?></a></dt>
<dd>
<?php if ($icon)
{
    ?>
    <div class="icon" style="float: left; margin-right: 8px;"><a style="text-decoration: none;" href="&(node[MIDCOM_NAV_FULLURL]);document/<?php echo $data['document']->guid; ?>/"><img src="&(icon);" <?php
        if ($view['document'])
        {
...
<ul>
    ...
    <?php
    if ($data['document_search']->abstract != 0)
    {
