 ...
 * @package net.nemein.opendeploydumper
 */
class net_nemein_opendeploydumper_state_dba extends __net_nemein_opendeploydumper_state_dba
{
    ...
    function net_nemein_opendeploydumper_state_dba($id = null)
    {
        return parent::__net_nemein_opendeploydumper_state_dba($id);
    }
    ...
    function get_for($input)
    {
        ...
        $qb = net_nemein_opendeploydumper_state_dba::new_query_builder();
    ...
    function create_for($object, $url, $action = 'created')
    {
        ...
        $state = new net_nemein_opendeploydumper_state_dba();
        $state->targeturl = $url;
    ...
    {
        if (net_nemein_opendeploydumper_state_dba::get_for($this->objectguid))
        {
