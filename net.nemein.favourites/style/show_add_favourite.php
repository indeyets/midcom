...
echo "    <input type='hidden' name='net_nemein_favourites_referer' value=" . midcom_helper_xsspreventer::escape_attribute($data['my_way_back']) . "/>\n";
echo "    <label class='net_nemein_favourites_label'><span>" . $data['l10n_midcom']->get('title') . "</span>\n";
echo "        <input type='text' name='net_nemein_favourite_title' value=" . midcom_helper_xsspreventer::escape_attribute($data['favourite_title']) . "/>\n";
echo "    </label>\n";
echo "<input type='submit' name='net_nemein_favourite_submit' value='" . $data['l10n']->get('add') . "'/>\n";
echo "</form>\n\n";
echo '<p><a href=' . midcom_helper_xsspreventer::escape_attribute($data['my_way_back']) . '>' . $data['l10n']->get('return and dont add') . "</a></p>\n";
?>