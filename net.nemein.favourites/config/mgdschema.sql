CREATE TABLE net_nemein_favourites_favourite (
  ...
  PRIMARY KEY (id),
  KEY net_nemein_favourites_objectType_idx(objectType),
  KEY net_nemein_favourites_objectGuid_idx(objectGuid),
  KEY net_nemein_favourites_objectTitle_idx(objectTitle)
);
