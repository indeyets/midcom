...
/**
 * This is a URL handler class for net.nemein.attention
 *
 ...
 * @package net.nemein.attention
 */
class net_nemein_attention_handler_index  extends midcom_baseclasses_components_handler
{
    ...
    {
        $this->_request_data['name']  = "net.nemein.attention";
