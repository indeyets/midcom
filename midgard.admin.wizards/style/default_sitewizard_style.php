...
<form method="post" name="sitewizard_style">
...
<?php    
        ...
        ?>
            <fieldset class="style">
              ...
              <label for="sitewizard_style_select_template_&(template.id);" class="action_select">
              <input type="radio" name="sitewizard_style_select_template" value="&(template.id);"
              id="sitewizard_style_select_template_&(template.id);" />&(template_name);</label>
...
?>
        ...
        <input type="submit" name="sitewizard_style_submit" value="<?php echo $data['l10n']->get('next'); ?>">
        </form> 
