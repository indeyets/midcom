...
?>
<div class="aish1"><h1><?php echo $data['l10n']->get("Move topic"); ?>: &(t_name);</h1></div>
<p>
<?php 
    echo $data['l10n']->get("Select the topic you want to move the topic to:"); ;
?>  
</p>
...
function set_moveto_value(id) {
   ...
   //moveto.value = id;
   if (window.confirm("<?php echo sprintf($data['l10n']->get("Move topic '%s' to "), $t_name); ?>" + document.f_move_topic.f_moveto.value + "?" )) {
