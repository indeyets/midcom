 ...
 * @package net.nehmer.publications
 */
class net_nehmer_publications_handler_archive extends midcom_baseclasses_components_handler
{
    /**
    ...
    /**
     * The list of filters added to the archive listing according to the current component
     * configuration.
     *
     * @var Array
     * @access private
     */
    var $_topic_filters = null;
    ...
    function _handler_welcome ($handler_id, $args, &$data)
    {
        ...
        $qb->set_limit(1);
        $publications = $qb->execute_unchecked();

        if ($publications)
        {
            $publication_time = $publications[0]->revised;
        }
        else
        {
            $publication_time = 0;
        ...
        $this->_component_data['active_leaf'] = NET_NEHMER_PUBLICATIONS_LEAFID_ARCHIVE;
    ...
    {
        // Get publications, distinguish by handler.
        $qb = new net_nehmer_publications_query();
